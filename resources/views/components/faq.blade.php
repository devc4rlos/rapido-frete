<x-container-with-title title="FAQ (Perguntas Frequentes)" isBackground>
    ...
    <div class="animate">
        ...
        <x-link-main :href="$getLink()" target="_blank" class="block mx-auto mt-6">Solicitar orçamento</x-link-main>
    </div>
