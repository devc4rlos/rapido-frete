<x-container-with-title title="Como funciona o nosso processo de mudança" isBackground id="listStep">
    <div class="timeline relative flex flex-col gap-20 max-w-7xl mx-auto p-5">
        <x-list-step.card-step
            id="1"
